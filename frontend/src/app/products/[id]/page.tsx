...
export default async function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const res = await fetch(`http://localhost:5011/api/products/${id}`, { cache: 'no-store' });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#f8f8f8] via-[#f0f0f0] to-[#fafafa] flex items-center justify-center p-6">
